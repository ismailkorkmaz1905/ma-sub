...
- Drive publication uses a temporary name, reads remote bytes back, compares exact byte count and SHA-256, and only then publishes the exact final name and PASS marker.
