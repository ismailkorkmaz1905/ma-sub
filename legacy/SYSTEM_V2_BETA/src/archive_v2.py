...
from .raw_asr_v2 import validate_publishable_raw_asr_v2_policy
...
def _v2_configuration_relatives() -> dict[str, str]:
    return {
        "series_config": "SYSTEM_V2_BETA/config/series.yaml",
        "names_config": "SYSTEM_V2_BETA/config/names.yaml",
        "religious_config": "SYSTEM_V2_BETA/config/religious_terms.yaml",
    }
