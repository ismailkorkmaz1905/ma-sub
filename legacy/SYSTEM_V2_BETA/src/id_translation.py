"""Strict Indonesian-only translation contract for the V2 subtitle pipeline.

V2 deliberately separates Turkish correction/timing from Indonesian
...
This module is intentionally independent of the V1 ``batches`` and
``translation_validation`` modules so V1 episodes remain reproducible.
"""
...
class IDTranslationError(ValueError):
    """Raised when a V2 ID pack, schema, or translated output is invalid."""
...
# Explicit aliases make the V2-only purpose discoverable without affecting V1.
