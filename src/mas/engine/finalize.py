"""Strict, atomic finalization from independently verified evidence.
...
from .workflow import build_strict_v2_artifacts
...
def finalize_episode_v2(
    *,
    ...
    supplied_config_dir = Path(series_config).resolve().parent
    if supplied_config_dir != production_config_dir.resolve():
        raise FinalizationV2Error("V2 configuration escaped the canonical config directory")
    system_config_dir = supplied_config_dir
